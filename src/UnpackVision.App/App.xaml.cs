...
public partial class App : System.Windows.Application
{
    ...
    private static readonly Lazy<IIpcDiscoveryService> IpcDiscoveryService =
        new(() => new CompositeIpcDiscoveryService(
            new OnvifIpcDiscoveryService(),
            new HikvisionSadpDiscoveryService()));
    internal static IIpcDiscoveryService IpcDiscovery => IpcDiscoveryService.Value;
    private static readonly Lazy<IStoragePoolMonitor> StoragePoolMonitorService =
        new(() => new RecordingStoragePoolMonitor(new SystemStorageDiskProbe()));
    internal static IStoragePoolMonitor StoragePoolMonitor => StoragePoolMonitorService.Value;
