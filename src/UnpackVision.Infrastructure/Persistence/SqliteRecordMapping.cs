...
internal static class SqliteRecordMapping
{
    ...
    internal static RecordMediaAsset ReadMediaAsset(SqliteDataReader reader) => new()
    {
        ...
        StorageTargetId = reader.GetString(reader.GetOrdinal("storage_target_id")),
        RelativeVideoPath = reader.GetString(reader.GetOrdinal("relative_video_path")),
        Codec = reader.GetString(reader.GetOrdinal("codec")),
        EncoderName = reader.GetString(reader.GetOrdinal("encoder_name")),
        HardwareAccelerated = reader.GetInt32(reader.GetOrdinal("hardware_accelerated")) != 0,
        WatermarkBurnedIn = reader.GetInt32(reader.GetOrdinal("watermark_burned_in")) != 0,
    ...
    internal static RecordMediaSegment ReadMediaSegment(SqliteDataReader reader) => new()
    {
        Id = Guid.Parse(reader.GetString(reader.GetOrdinal("id"))),
        MediaAssetId = Guid.Parse(reader.GetString(reader.GetOrdinal("media_asset_id"))),
