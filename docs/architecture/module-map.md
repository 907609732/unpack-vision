...
| Media | Recording/preview ports, camera-source discovery contracts, multi-camera asset and gap contracts, playback alignment, relay authorization | OpenCV/MediaMTX/ISAPI transport details | Media, range, relay and camera tests |
